...
local METRIC_NAMES = {
  ...
  "shdict_usage","request_count_per_api","request_count_per_user_per_api"
}
...
local DEFAULT_METRICS = {
  ...
  {
    name                = "request_count_per_user_per_api",
    stat_type           = "counter",
    sample_rate         = 1,
    consumer_identifier = nil,
    service_identifier  = nil,
...
return {
  ...
  fields = {
    ...
    { config = {
        type = "record",
        fields = {
          { host = typedefs.host({ default = "statsd-exporter" }), },
          { port = typedefs.port({ default = 9125 }), },
