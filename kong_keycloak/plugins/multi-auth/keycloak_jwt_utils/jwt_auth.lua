...
local keycloak_keys = require("kong.plugins.multi-auth.keycloak_jwt_utils.keycloak_keys")
local table_to_string = require("kong.plugins.multi-auth.utils").table_to_string

local validate_issuer = require("kong.plugins.multi-auth.keycloak_jwt_utils.validators.issuers").validate_issuer
local validate_scope = require("kong.plugins.multi-auth.keycloak_jwt_utils.validators.scope").validate_scope
local validate_roles = require("kong.plugins.multi-auth.keycloak_jwt_utils.validators.roles").validate_roles
local validate_realm_roles = require("kong.plugins.multi-auth.keycloak_jwt_utils.validators.roles").validate_realm_roles
local validate_client_roles = require("kong.plugins.multi-auth.keycloak_jwt_utils.validators.roles").validate_client_roles
...
local function keycloak_authenticate(conf)
...
return {
    keycloak_authenticate = keycloak_authenticate
}